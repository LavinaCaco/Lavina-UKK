...
class C_lavinaAuth extends CI_Controller
{
    ...
    public function register()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('V_lavinaReg', $data);
        } else {
    ...
    public function setup()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data['title'] = 'Register Account';
            $this->load->view('admin/V_lavinaSetup', $data);
        } else {
            ...
            redirect('C_lavinaAuth/login_admin');
        }
    }
    ...
    public function registrasi_petugas()
    {
        ...
        $this->M_lavinaAdmin->insertpetugas($data);
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">
			Congratulation your account has been created !
		  	</div>');
