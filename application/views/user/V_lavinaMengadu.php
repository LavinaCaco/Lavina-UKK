    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <br>
                <form method="post" action="<?= base_url('C_lavinaUser/tambahmengadu') ?>" enctype="multipart/form-data">
                <fieldset disabled>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="isi_laporan" id="isi_laporan" placeholder="Masukan Laporan"></textarea>
                    </div>
