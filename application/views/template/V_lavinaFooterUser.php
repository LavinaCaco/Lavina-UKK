  ...
  <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; UKK Lavina Arsya 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?= base_url('C_lavinaAuth/logout ')?>">Logout</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
 ...
 $('#kategori').change(function(){ 
     var id=$(this).val();
     $.ajax({
         url : "<?php echo base_url()?>C_lavinaUser/get_sub_kategori",
         method : "POST",
         data : {id : id},
         async : true,
         dataType : 'json',
